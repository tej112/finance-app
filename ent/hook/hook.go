...
// The Bank_TransferFunc type is an adapter to allow the use of ordinary
// function as Bank_Transfer mutator.
type Bank_TransferFunc func(context.Context, *ent.BankTransferMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f Bank_TransferFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.BankTransferMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.BankTransferMutation", m)
}
...
// The CreditCardFunc type is an adapter to allow the use of ordinary
// function as CreditCard mutator.
type CreditCardFunc func(context.Context, *ent.CreditCardMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f CreditCardFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.CreditCardMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.CreditCardMutation", m)
}
